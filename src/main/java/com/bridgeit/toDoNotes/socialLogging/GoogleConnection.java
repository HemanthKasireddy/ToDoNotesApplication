...
public class GoogleConnection {
	...
	private  static Logger logger = Logger.getLogger(GoogleConnection.class);

	private static final String googleClientId="510458487033-iigm55q4f2f7jmsc9b998mlu5u298fnj.apps.googleusercontent.com";
	private static final String googleSecretId="Y57lwpEhHt4XvoeyRq0yq-wU";
	public static final String Redirect_URI = "http://localhost:8080/ToDoNotesApp/connectGoogle";
	...
	public String getGoogleURL(String unid) {
		...
		logger.debug("inside google authentication" + googleLoginURL);
	...
	public String getAccessToken(String authCode) {
		...
		try {
			...
			logger.debug("@@@@@@@@@@@@@@@@@@@@Acess token is null    "+ acc_token);
